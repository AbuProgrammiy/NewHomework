import {
  ...
  SortAmountDownIcon,
  SortAmountUpAltIcon
} from "./chunk-CHROM7YB.js";
import {
  DomHandler,
  Ripple,
  RippleModule,
  SpinnerIcon
} from "./chunk-Y6DVXYUU.js";
import {
  BaseIcon
} from "./chunk-YPUGSYON.js";
import {
  FilterService,
  ObjectUtils,
  PrimeNGConfig,
  PrimeTemplate,
  SharedModule
} from "./chunk-OT362SAH.js";
import "./chunk-3WN46T5Y.js";
import "./chunk-36VKEHBZ.js";
import {
  CommonModule,
  DOCUMENT,
  NgClass,
...
var TTCheckbox = class _TTCheckbox {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function TTCheckbox_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵproperty("ngClass", ɵɵpureFunction1(6, _c29, ctx.focused));
        ɵɵadvance(2);
        ɵɵproperty("checked", ctx.checked);
        ɵɵadvance();
        ɵɵproperty("ngClass", ɵɵpureFunction4(8, _c30, ctx.checked, ctx.focused, ctx.partialChecked, ctx.disabled));
...
var TTHeaderCheckbox = class _TTHeaderCheckbox {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function TTHeaderCheckbox_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵproperty("ngClass", ɵɵpureFunction1(7, _c29, ctx.focused));
        ɵɵadvance(2);
